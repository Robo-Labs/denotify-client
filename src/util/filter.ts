...
export class Filter {
	...
	private static process(record: any, conditions: Condition[], lhs?: boolean): boolean {
	...
	private static execCondition(record: any, condition: Condition): boolean {
...
export class FilterBuilder {
	...
	public addCondition(logic: Logic, key: string, type: FilterDataTypes, operation: FilterOpertationType, constant: string | number): FilterBuilder {
